...
module.exports.start = function(config) {
  ...
  server = net.createServer(function(socket) {
    ...
    Object.defineProperty(r.context, 'getTools',{
      get: function() {
    ...
    // 'getConsole' in the repl grabs the degug and console log streams

    Object.defineProperty(r.context, 'getConsole', {
      get: function() {
    ...
    // 'freeConsole' in the repl releases the debug and console log streams

    Object.defineProperty(r.context, 'freeConsole', {
      get: function() {
        objective.repls[id].grabbed = false;
        require('debug').setStream();
        console._stdout = process.stdout;
