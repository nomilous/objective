...
module.exports.error = function() {
  var place = {};
  filename = objective.getCallerFileName(2,place);
  error('in - %s:%s:%s', filename, place.lineNumber, place.columnNumber);
...
module.exports.TODO = function() {
  ...
  var filename = objective.getCallerFileName(2).replace(process.cwd() + path.sep, '');
  args.push(filename);
