...
if (typeof OriginalError === 'undefined') {
  ...
  Object.defineProperty(ExpandedError, 'prepareStackTrace', {
    enumarable: false,
    // ExpandedError stack trace prep modifies original Error
    get: function() {
  ...
  ExpandedError.captureStackTrace = function(obj) {
    // Expanded error capture runs original
    OriginalError.captureStackTrace(obj);
  }

  global.ExpandedError = ExpandedError;
  global.OriginalError = Error;
  global.Error = ExpandedError; // Bang!
                               //
                              // Possibly an overly bold move.
