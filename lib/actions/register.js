    ...
    retry = function() {
      ...
      return prompt.get({
        ...
        return request.post({
          ...
          fs.writeFileSync(process.env.HOME + '/.objective/templates/default.coffee', "uuid: '__UUID__'\ntitle: ''\ndescription: ''\nprivate: __PRIVATE__\nroot: (done) ->\n\n    done()\n");
          fs.writeFileSync(process.env.HOME + '/.objective/templates/dev.coffee', "uuid: '__UUID__'\ntitle: ''\ndescription: ''\nprivate: __PRIVATE__\nmodules: ['objective-dev']\nroot: (done) ->\n    \n    done()\n");
          ...
          fs.writeFileSync(process.env.HOME + '/.objective/templates/dev/default_spec.coffee', "uuid: '__UUID__'\ntitle: '__TITLE__'\ndescription: ''\nprivate: __PRIVATE__\nmodules: []\nroot: ->\n    \n    context '', ->\n\n        it ''\n");
          console.log('\n');
