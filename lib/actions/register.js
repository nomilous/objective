...
module.exports = register = {
  "do": function(program, callback) {
    ...
    return register.prompt_email().then(function() {
  ...
  prompt_email: deferred(function(action) {
    var retry;
    retry = function() {
      ...
      return prompt.get('email', function(err, res) {
        ...
        email = res.email;
        return request.post('https://ipso.io/api/register/email/' + email, function(error, response, body) {
          if (error != null) {
            console.log(error);
            process.exit(1);
          }
