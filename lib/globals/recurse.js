...
var createEvent, debug, deferred, emit, error, fs, info, isBinaryFile, mkpath, normalize, pipeline, recurse, ref, ref1, ref2;
...
ref2 = require('../logger'), info = ref2.info, debug = ref2.debug, error = ref2.error;
