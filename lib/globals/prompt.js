...
var appendToCommand, autoComplete, autoCompleteAssemble, autoCompleteStartsWith, backspace, bell, command, commands, createEvent, cursorScroll, emit, endSearch, fs, handleKeyStrokes, history, historyCursor, historyFile, historyScroll, historySearch, keypress, lastPart, latestCommand, normalize, offset, postPrompt, prePrompt, promptWidth, prompting, ref, ref1, runCommand, running, searchLine, searching, sep, setPrompt, showHelp, updateSearch, writeAutoCompletePosibilities, writePrompt;
...
autoComplete = function() {
  var args, base, cmd, err, j, len, line, possibilities, ref2;
  offset = 0;
